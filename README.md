#MORM
[![Build Status](https://github.com/bgrusnak/morm.git)]
=======
The minimalistic ORM  (Object-relational mapping) for Erlang
...
## Relations
There is currently two different relations in morm;
...
# Build
To build morm use Makefile to build.
...
## Documentation
To generate documentation of morm:
